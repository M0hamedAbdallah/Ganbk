...

                            {
                                (filtereddata.length >= 1)
                                    ...
                                    filtereddata.map((item, index) => {
                                        ...
                                        if (disabled) {
                                            return (
                                                <TouchableOpacity style={[styles.disabledoption, disabledItemStyles, { flexDirection: direction.direction }]} key={index} onPress={() => { }}>
                                    ...
                                    :
                                    <TouchableOpacity style={[styles.option, dropdownItemStyles, { flexDirection: direction.direction }]} onPress={() => {
